...
{
  /* The TeamPendingAssessmentsTable component displays a table of teams using the DataGrid component from MUI.
...
// Define the TeamPendingAssessmentsTable component
const TeamPendingAssessmentsTable = ({ gridColumn, gridRow, abn, name }) => {
  // Access the current theme
  const theme = useTheme();
  const TableName = "Team's Pending Assessments";
  ...
  const incompleteAssessments = data?.incompleteAssessments;
  ...
  return (
    ...
    >
      ...
      <DataGrid
        ...
        rows={incompleteAssessments || []} // Data to be displayed in the grid
...
// Export the TeamPendingAssessmentsTable component as the default export
export default TeamPendingAssessmentsTable;
