...
import AddMembers from "scenes/team/AddMembers";

// Define the 'AddMembersButton' component
const AddMembersButton = ({
  ...
  // Define a handler function to refetch data, update the form visibility and re-render parent
  const handleRender = () => {
    refetchTeamData();
    refetchAssessmentData();
  ...
  return (
    ...
    >
      {/* A Button to trigger the 'Add Members' form */}
      <Button
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* Include the 'AddMembers' component, passing necessary props */}
              <AddMembers
...
// Export the 'AddMembersButton' component as the default export
